  ...
  return (
    <div>
      ...
      <div className="flex items-center mb-[20px] justify-between">
        <div>
          <Input.Search style={{ width: 200 }} className="w-[300px]" size="large" />
        </div>
        <div className="flex items-center">
          ...
          <Button
            ...
            color="info"
            onClick={() => {
              window.electron.checkHashCode('IPC is working !!!');
            }}
          >
            TestSetWindowTitle
          </Button>
          <Button
            ...
            color="info"
            onClick={() => {
              window.electron.checkHashCode('5064c7f8d5f719ac6a234869515aad55');
            }}
          >
            TestMD5
          </Button>
